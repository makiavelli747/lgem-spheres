...
country = {
	...
	BADBOY_LIMIT = 25,
	MAX_BUREAUCRACY_PERCENTAGE = 0.001, -- More than max percent bureaucrats of poplation will give no additional benefits
	BUREAUCRACY_PERCENTAGE_INCREMENT = 0.00, -- For each social administrative reform level, this is added to MAX_BUREAUCRACY_PERCENTAGE
...
economy = {
	...
	TRADE_CAP_LOW_LIMIT_CONSTRUCTIONS = 0.75, 		-- the lowest % the slider can go for constructions
