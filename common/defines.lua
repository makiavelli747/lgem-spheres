...
economy = {
	...
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 1,
	BANKRUPTCY_FACTOR = 0.1,
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 15000000,
	...
	TRADE_CAP_LOW_LIMIT_LAND = 1, 				-- the lowest % the slider can go for land units
...
military = {
	...
	AI_ESCORT_RATIO = 0.1, -- ratio of escorts to transports in invasion fleets
...
diplomacy = {
	...
	INFAMY_RELEASE_PUPPET = 2,
	INFAMY_MAKE_PUPPET = 4,
	...
	ALLIANCE_RELATION_ON_ACCEPT = 10,
	...
	EXPELADVISORS_INFLUENCE_COST = 150,
	...
	AT_WAR_TENSION_DECAY = -0.1, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	...
	CRISIS_INTEREST_WAR_EXHAUSTION_LIMIT = 1, -- GPs with WE above this will not get invited to a crisis
	
	RANK_1_TENSION_DECAY = -0.10, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.09,
	RANK_3_TENSION_DECAY = -0.08,
	RANK_4_TENSION_DECAY = -0.07,
	RANK_5_TENSION_DECAY = -0.06,
...
ai =
{
	...
	PRODUCTION_WEIGHT = 50.0, -- ai weight for new production
	...
	FLEET_SIZE = 300, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
	...
	MONTHS_BEFORE_DISBAND = 1, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil)
},
