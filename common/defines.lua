...
ai =
{
	...
	TWS_AWARENESS_SCORE_LOW_CAP = 1, -- AI will always add CBs if current warscore is less then that number (including TWS)
	TWS_AWARENESS_SCORE_ASPECT = 1, -- AI will not add any more CBs when TWS is more then X% of total WS. (to not destroy the progress)
